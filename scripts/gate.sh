...
export TOOLCHAIN="${OXML_LSP_TOOLCHAIN:-1.98.0}"
MSRV="${OXML_LSP_MSRV:-1.86.0}"
...
# `lint.sh` asserts its output and says so in its own header; nothing
# ran it until 0.0.7.
