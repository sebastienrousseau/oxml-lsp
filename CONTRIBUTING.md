...
[**good first issue**](https://github.com/sebastienrousseau/oxml-lsp/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
and anything the maintainer would welcome help with is labelled
[**help wanted**](https://github.com/sebastienrousseau/oxml-lsp/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
...
```bash
git clone https://github.com/sebastienrousseau/oxml-lsp
cd oxml
cargo test
```
